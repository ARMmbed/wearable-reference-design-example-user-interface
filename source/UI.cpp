...
#ifdef YOTTA_CFG_HARDWARE_WEARABLE_REFERENCE_DESIGN_BUTTON_PIN_FORWARD
#define BUTTON_FORWARD YOTTA_CFG_HARDWARE_WEARABLE_REFERENCE_DESIGN_BUTTON_PIN_FORWARD
#else
#error Platform not supported
#endif

#if defined(YOTTA_CFG_HARDWARE_WEARABLE_REFERENCE_DESIGN_TOUCH_SLIDER_BACK)
#define BUTTON_BACK YOTTA_CFG_HARDWARE_WEARABLE_REFERENCE_DESIGN_TOUCH_SLIDER_BACK
#elif defined(YOTTA_CFG_HARDWARE_WEARABLE_REFERENCE_DESIGN_BUTTON_PIN_BACKWARD)
#define BUTTON_BACK YOTTA_CFG_HARDWARE_WEARABLE_REFERENCE_DESIGN_BUTTON_PIN_BACKWARD
#else
#error Platform not supported
#endif
